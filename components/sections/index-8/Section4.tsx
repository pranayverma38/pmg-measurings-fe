                                    ...
                                    <div className="at-service-img-wrapper image-container sec-4-home-8__img-stack">
                                        {hoverImages.map((img, index) => (
                                            <div className="hover-image" key={`hover-${index}`}>
                                                <Image className="thumb" src={img} alt="orisa" width={500} height={400} />
                                            </div>
                                        ))}
                                    </div>
                            ...
                            <Link href="/services-details">
                                <div className="at-service-item service-item active">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <Image data-speed=".9" src="/assets/imgs/pages/home-8/hero8-sec4-hover-1.webp" alt="orisa" width={300} height={200} />
                                    </div>
                                </div>
                            </Link>
                            <Link href="/services-details">
                                <div className="at-service-item service-item">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <Image src="/assets/imgs/pages/home-8/hero8-sec4-hover-2.webp" alt="orisa" width={300} height={200} />
                                    </div>
                                </div>
                            </Link>
                            <Link href="/services-details">
                                <div className="at-service-item service-item">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <Image data-speed=".9" src="/assets/imgs/pages/home-8/hero8-sec4-hover-3.webp" alt="orisa" width={300} height={200} />
                                    </div>
                                </div>
                            </Link>
                            <Link href="/services-details">
                                <div className="at-service-item service-item">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <Image data-speed=".9" src="/assets/imgs/pages/home-8/hero8-sec4-hover-4.webp" alt="orisa" width={300} height={200} />
                                    </div>
                                </div>
                            </Link>

                            <div className="at-service-btn pt-30">
                                <Link className="at-btn at_fade_anim" href="/contact-1">
                                    <span>
