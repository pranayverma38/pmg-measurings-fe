                ...
                <div className="sec-4-home-13__bottom">
                    <div className="sec-4-home-13__copy">
                        ...
                        <ul className="sec-4-home-13__chips list-unstyled mb-0">
                            <li><Link className="sec-4-home-13__chip at_fade_anim text-white" data-fade-from="left" data-delay=".1" href="/contact-1"><span aria-hidden="true">&rarr;</span> New project</Link></li>
                            <li><Link className="sec-4-home-13__chip at_fade_anim text-white" data-fade-from="left" data-delay=".2" href="/contact-1">Talk to a partner</Link></li>
                            <li><Link className="sec-4-home-13__chip at_fade_anim text-white" data-fade-from="left" data-delay=".3" href="/contact-1">Schedule a visit</Link></li>
                        </ul>
                    </div>

                    <div className="sec-4-home-13__contact">
                        <p className="sec-4-home-13__contact-label mb-0">CONTACT</p>
                        <a className="sec-4-home-13__contact-row" href="mailto:pmgmeasuringtape@gmail.com">
                            <span className="sec-4-home-13__contact-mail at-rise-animation text-white">pmgmeasuringtape@gmail.com</span>
                        ...
                        <p className="sec-4-home-13__contact-label mt-3 mb-0">9202331313</p>
                        <p className="sec-4-home-13__contact-label mt-1 mb-0">New Delhi, India</p>
                    </div>
                </div>
