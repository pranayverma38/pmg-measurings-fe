            ...
            <div className="container-2200 px-lg-5 px-3">
                <div className="row g-0 align-items-start">
                    ...
                    <div className="col-xl-5 col-lg-5 col-12 sec-8-home-7__lead">
                        <Link href="/team" className="sec-8-home-7__eyebrow d-inline-flex align-items-center gap-2 mb-4 text-uppercase">
                        ...
                        <div className="sec-4-home-7__cta d-inline-flex align-items-stretch mb-60 at_fade_anim">
                            <Link href="/team" className="at-btn sec-4-home-7__cta-btn text-capitalize">
                                <span>
                                    <span className="text-1">Join our Team</span>
                                    <span className="text-2">Join our Team</span>
                                </span>
                            </Link>
                            <Link href="/team" className="sec-4-home-7__cta-circle d-inline-flex align-items-center justify-content-center text-white" aria-label="Join our Team">
                                {CTA_CIRCLE_SVG}
                            </Link>
                        </div>
                    </div>
                                    ...
                                    >
                                        <div className="sec-8-home-7__photo">
                                            <div className="fix anim-zoomin">
                                                <Image src={member.img} alt={member.alt} width={400} height={480} />
                                            </div>
                                        </div>
