...
const TESTIMONIALS = [
    {
        ...
        company: "BuildRight Infrastructure, Mumbai",
    },
    {
        quote:
        ...
        company: "Allied Hardware Supplies, Delhi",
    },
    {
        quote:
        ...
        company: "Precision Woodworks, Bengaluru",
    },
    {
        quote:
        ...
        img: "/assets/imgs/template/avatar/avatar-9.webp",
        name: "Ananya Reddy",
        position: "Operations Lead",
        company: "ClearView Glazing, Hyderabad",
    },
    {
        quote:
        ...
        img: "/assets/imgs/template/avatar/avatar-10.webp",
        name: "Vikram Patel",
        position: "Regional Buyer",
        company: "TradeMart Tools, Ahmedabad",
    },
];
                            ...
                            <div className="col-lg-5 h-100">
                                <div className="section-title-pin h-100">
                                    ...
                                    <div
                                        ...
                                        data-ease="bounce"
                                    >
                                        <Link className="at-btn-circle" href="/products">
                                            {ARROW_16_SVG}
                                        </Link>
                                        <Link className="at-btn z-index-1" href="/products">
                                            Browse our products
                                        </Link>
                                        <Link className="at-btn-circle" href="/products">
                                            {ARROW_16_SVG}
