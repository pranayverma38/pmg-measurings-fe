...
export default function Section10() {
    return (
        <div className="sec-10-home-7 bg-neutral-0 pt-120 pb-120">
            <div className="container-2200 px-lg-5 px-3">
                <div className="row align-items-end mb-50">
                    <div className="col-xl-4 col-lg-4 col-12">
                        <Link href="/archive-1" className="sec-10-home-7__eyebrow d-inline-flex align-items-center gap-2 mb-4 text-uppercase">
                            <span className="text-scramble" data-scramble-text="Inside Startup">Inside Startup</span>
                            {EYEBROW_ARROW_SVG}
                        </Link>
                        <h2 className="sec-10-home-7__title mb-0 reveal-text">
                            <RevealText>Insights for <br className="d-none d-sm-inline" />Founders</RevealText>
                        </h2>
                    </div>
                    ...
                    <div className="col-xl-3 col-lg-12 mt-4 mt-lg-4 mt-xl-0 ms-xl-auto text-xl-end">
                        <Link href="/archive-1" className="sec-10-home-7__btn-all d-inline-flex align-items-center gap-2 at_fade_anim">
                            ...
                            <div className="blog-card mb-30" data-category="">
                                ...
                                <div className="blog-card__content">
                                    <h2 className="h6 blog-card__title">
                                        <Link href="/blog-details" className="blog-card__title-link">{insight.title}</Link>
                                    </h2>
                                    <p className="blog-card__meta">
                                        <span className="blog-card__meta-text">By </span>
                                        <Link href="/team-details" className="blog-card__author">{insight.author}</Link>
