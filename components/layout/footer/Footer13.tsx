            ...
            <div className="footer-13__body">
                <div className="footer-13__top">
                    <div className="footer-13__brand at_fade_anim" data-fade-from="bottom" data-delay=".1">
                        <Link className="footer-13__logo" href="/">
                            <img src="/assets/imgs/template/logo/favicon.svg" alt="Orisa" />
                    ...
                    <nav className="footer-13__cols" aria-label="Footer navigation">
                        <div className="footer-13__col at_fade_anim" data-fade-from="bottom" data-delay=".2">
                            ...
                            <ul className="footer-13__col-list list-unstyled mb-0">
                                ...
                                <li><Link href="/services-1">Process</Link></li>
                                <li><Link href="/about-1">Awards</Link></li>
                                <li><Link href="/archive-1">Press</Link></li>
                        ...
                        <div className="footer-13__col at_fade_anim" data-fade-from="bottom" data-delay=".3">
                            ...
                            <ul className="footer-13__col-list list-unstyled mb-0">
                                <li><Link href="/portfolio-1">Selected</Link></li>
                                <li><Link href="/portfolio-1">Residential</Link></li>
                                <li><Link href="/portfolio-1">Cultural</Link></li>
                                <li><Link href="/portfolio-1">Commercial</Link></li>
                                <li><Link href="/portfolio-1">Master Plans</Link></li>
                            </ul>
                        </div>
                        <div className="footer-13__col at_fade_anim" data-fade-from="bottom" data-delay=".4">
                            ...
                            <ul className="footer-13__col-list list-unstyled mb-0">
                                <li><a href="mailto:pmgmeasuringtape@gmail.com">pmgmeasuringtape@gmail.com</a></li>
                                <li><a href="tel:9202331313">9202331313</a></li>
                                <li>New Delhi, India</li>
                                <li><Link href="/contact-1">Press inquiries</Link></li>
                                <li><Link href="/contact-1">Schedule a visit</Link></li>
                                <li><Link href="/contact-1">Job applications</Link></li>
                            </ul>
                        </div>
                    </nav>
                </div>
