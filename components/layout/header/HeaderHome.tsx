...
export default function HeaderHome({ style }: HeaderHomeProps = {}) {
    ...
    return (
        <>
            <header>
                <div className="at-header-area at-header-spacing header-transparent header-home">
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-xl-2 col-6">
                                <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                                    <button className="at-menu-bar at-header-sidebar-btn text-white">
            ...
            <style
                dangerouslySetInnerHTML={{
                    __html: `@media (min-width: 768px) { .header-home.at-header-area { width: 90%; max-width: 90%; left: 0; right: 0; margin-left: auto; margin-right: auto; } }`,
                }}
            />
        </>
    );
