...
import StickyCardsEffect from "@/components/effects/StickyCardsEffect";
        ...
        <section className="sec-4-home-15 pt-65 pb-65" aria-label="Selected work">
            ...
            <div className="container">
                ...
                <div className="sec-4-home-15__cards">
                    {PROJECTS.map((p) => (
                        <Link key={p.name} className="sec-4-home-15__card anim-zoomin-wrap" href="/portfolio-details-1" aria-label={`View case: ${p.name}`}>
                            <img className="sec-4-home-15__card-img anim-zoomin" src={`/assets/imgs/pages/home-15/${p.img}`} alt="Orisa" />
