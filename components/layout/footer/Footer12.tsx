                ...
                <div className="container-fluid px-3 px-lg-5">
                    ...
                    <div className="footer-12__columns">
                        <div className="footer-12__col footer-12__col--brand">
                            <Link className="footer-12__brand" href="/index-12" aria-label="Orisa home">
                                <img className="footer-12__brand-logo" src="/assets/imgs/template/logo/logo-w.svg" alt="Orisa" />
                            </Link>
                        ...
                        <div className="footer-12__col">
                            ...
                            <ul className="footer-12__col-links">
                                ...
                                <li><Link href="/services-details">Process</Link></li>
                        ...
                        <div className="footer-12__col">
                            ...
                            <ul className="footer-12__col-links">
                                <li><Link href="/portfolio-1">Selected projects</Link></li>
                                <li><Link href="/portfolio-details-1">Case studies</Link></li>
