        ...
        <section className="sec-2-home-12" aria-label="Selected Projects">
            <div className="container">
                ...
                <div className="sec-2-home-12__cards">
                    {PROJECTS.map((p) => (
                        <Link key={p.num} className="card-home-12-project" href={p.link} aria-label={`${p.title} — view project`}>
                            <div className="card-home-12-project__image anim-zoomin-wrap">
                                <img className="card-home-12-project__img anim-zoomin" src={`/assets/imgs/pages/home-12/${p.img}`} alt="Orisa" />
                            </div>
