        ...
        <section className="sec-3-home-12" aria-label="Our Services">
            <div className="container">
                ...
                <div className="sec-3-home-12__grid">
                    {SERVICES.map((s) => (
                        <Link key={s.num} className="card-home-12-service at_fade_anim" data-fade-from="bottom" data-delay={s.delay} href="/services-details" aria-label={`${s.title} — view service`}>
