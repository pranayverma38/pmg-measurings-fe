                ...
                <div className="row align-items-end mb-50 g-4">
                    ...
                    <div className="col-xxl-2 col-md-4 ms-lg-auto d-flex justify-content-lg-end">
                        <div className="at-btn-group at_fade_anim" data-delay=".4" data-fade-from="bottom" data-ease="bounce">
                            ...
                            <Link className="at-btn z-index-1" href="/archive-1">View all articles</Link>
                            <Link className="at-btn-circle" href="/archive-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 16 15" fill="none">
                                    <path d="M0.0001297 8.99993L0 3.00407e-05L2 0L2.0001 6.99993L12.1719 7.00003L8.22224 3.05027L9.63644 1.63606L16.0003 8.00003L9.63644 14.364L8.22224 12.9497L12.1719 9.00003L0.0001297 8.99993Z" fill="currentColor" />
                                </svg>
                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-4 col-12">
                        <div className="alt-portfolio-item mb-30 at-hover-item">
                            <Link href="/blog-details" className="alt-portfolio-thumb rounded-0 mb-15 p-relative fix d-block">
                                <Image className="w-100 scale-img-from-to" data-value-1="1.5" data-value-2="1" src="/assets/imgs/pages/home-8/sec-10-1.webp" alt="orisa" width={600} height={450} />
                            ...
                            <div className="blog-card__thumb rounded-0 hover-effect-1">
                                <Link href="/blog-details" className="blog-card__img-link">
                                    <span className="anim-zoomin">
                                        <Image src="/assets/imgs/pages/home-8/sec-10-2.webp" className="blog-card__img" alt="orisa" width={600} height={400} />
                                    </span>
                                </Link>
                            </div>
                            <div className="blog-card__content mt-30">
                                <h3 className="h5 blog-card__title">
                                    <Link href="/blog-details" className="blog-card__title-link">The ROI of Empathy: Why User Research is Your Best Business Investment.</Link>
                                </h3>
                                <p className="blog-card__meta">
                                    <span className="blog-card__meta-text">By </span>
                                    <Link href="/team-details" className="blog-card__author">Olivia</Link>
                    ...
                    <div className="col-lg-4 col-12">
                        <div>
                            <div className="blog-card__thumb rounded-0 hover-effect-1">
                                <Link href="/blog-details" className="blog-card__img-link">
                                    <span className="anim-zoomin">
                                        <Image src="/assets/imgs/pages/home-8/sec-10-3.webp" className="blog-card__img" alt="orisa" width={600} height={400} />
                                    </span>
                                </Link>
                            </div>
                            <div className="blog-card__content mt-30">
                                <h3 className="h5 blog-card__title">
                                    <Link href="/blog-details" className="blog-card__title-link">The Secret Weapon for Scaling Global Digital Products.</Link>
                                </h3>
                                <p className="blog-card__meta">
                                    <span className="blog-card__meta-text">By </span>
                                    <Link href="/team-details" className="blog-card__author">Lucas</Link>
