                ...
                <div className="row g-4 g-xl-5 align-items-start">
                    <div className="col-xl-4 col-lg-5 col-12">
                        ...
                        <div className="sec-5-home-7__cta d-inline-flex align-items-stretch at_fade_anim">
                            <Link href="/contact-1" className="at-btn sec-5-home-7__cta-btn text-capitalize">
                                <span>
                                    <span className="text-1">Get a free quote</span>
                                    <span className="text-2">Get a free quote</span>
                                </span>
                            </Link>
                            <Link href="/contact-1" className="sec-5-home-7__cta-circle d-inline-flex align-items-center justify-content-center text-white" aria-label="Get a free quote">
                                {CTA_CIRCLE_SVG}
                            </Link>
                        </div>
                    </div>
