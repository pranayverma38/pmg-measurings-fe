...
const MEMBERS = [
    {
        id: "1",
        href: "/team-details-1",
        img: "/assets/imgs/pages/home-10/sec-6-member-1.webp",
        firstName: "Darrell",
        lastName: "Steward",
        role: "UI/UX Designer",
        fabVariant: "light",
    ...
    },
    {
        id: "2",
        href: "/team-details-1",
        img: "/assets/imgs/pages/home-10/sec-6-member-2.webp",
        firstName: "Esther",
        lastName: "Howard",
    ...
    },
    {
        id: "3",
        href: "/team-details-1",
        img: "/assets/imgs/pages/home-10/sec-6-member-3.webp",
        firstName: "Amelia",
        lastName: "Courtney",
    ...
    },
    {
        id: "4",
        href: "/team-details-1",
        img: "/assets/imgs/pages/home-10/sec-6-member-4.webp",
        firstName: "Jacob",
        lastName: "Jones",
        role: "Marketing CEO",
        fabVariant: "light",
            ...
            <div className="sec-6-home-10__container">
                <div className="sec-6-home-10__layout">
                    ...
                    {MEMBERS.map((member) => (
                        <article
                            key={member.id}
                            className={`sec-6-home-10__member sec-6-home-10__member--${member.id} at_fade_anim`}
                            data-delay={member.delay}
                        >
                            <Link className="sec-6-home-10__member-link" href={member.href}>
                                <div className="sec-6-home-10__member-frame">
                                    ...
                                    <div className="sec-6-home-10__member-overlay">
                                        <h3 className="sec-6-home-10__member-name mb-0">
                                            <span className="d-block">{member.firstName}</span>
                                            <span className="d-block">{member.lastName}</span>
                                        </h3>
                                        <p className="sec-6-home-10__member-role mb-0">{member.role}</p>
                                    </div>
                                    <span
                                        className={`sec-6-home-10__member-fab sec-6-home-10__member-fab--${member.fabVariant}`}
                                        aria-hidden="true"
                                    >
                                        {FAB_ARROW_SVG}
                                    </span>
                    ...
                    <div className="sec-6-home-10__foot at_fade_anim" data-delay="0.18">
                        ...
                        <Link className="sec-6-home-10__cta d-inline-flex align-items-center gap-3 mt-4 at_fade_anim" href="/contact-1">
                            <span>Get a free quote</span>
                            <svg className="sec-6-home-10__cta-arrow" xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 14 13" fill="none" aria-hidden="true">
