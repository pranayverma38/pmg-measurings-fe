                ...
                <div className="row align-items-end gx-4 gy-4 mb-60">
                    ...
                    <div className="col-xxl-3 col-xl-4 col-lg-3 d-flex justify-content-lg-end">
                        <div className="at-btn-group at_fade_anim" data-delay=".4" data-fade-from="bottom" data-ease="bounce">
                            <Link className="at-btn-circle" href="/portfolio-1">{ARROW_BTN}</Link>
                            <Link className="at-btn z-index-1" href="/portfolio-1">View latest projects</Link>
                            <Link className="at-btn-circle" href="/portfolio-1">{ARROW_BTN}</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="row gx-4 gy-4">
                    <div className="col-xxl-5 col-xl-6 col-lg-6">
                        <div className="sec-2-home-15__media-1 anim-zoomin-wrap">
                            <img className="sec-2-home-15__media-1-img anim-zoomin" src="/assets/imgs/pages/home-15/sec-2-img-1.webp" alt="Orisa" />
                ...
                <div className="row gx-4 gy-5 mt-30 align-items-center">
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                        <div className="sec-2-home-15__media-2 anim-zoomin-wrap">
                            <img className="sec-2-home-15__media-2-img anim-zoomin" src="/assets/imgs/pages/home-15/sec-2-img-2.webp" alt="Orisa" />
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                        <div className="sec-2-home-15__statement at_fade_anim" data-fade-from="bottom" data-delay=".3">
                            <img className="sec-2-home-15__statement-icon" src="/assets/imgs/pages/home-15/sec-2-shape-25.svg" alt="Orisa" />
