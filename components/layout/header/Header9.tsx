...
export default function Header9() {
  return (
    <>
      <header className="header-9 header-7">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-10 col-6">
                <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                  <div id="header7Nav" className="at-main-menu menu-light d-inline-flex justify-content-center style-1">
                    <nav className="at-mobile-menu-active">
                      <MainMenu />
                    </nav>
                  </div>
                  <div className="at-main-menu menu-light style-1 gap-3 d-flex justify-content-end align-items-center">
                    <button className="at-header-menu-btn at-hamburger size-40 text-white" type="button">
