    ...
    return (
        <>
            {Array.from({ length: 5 }).map((_, i) => (
                <Image key={i} src="/assets/imgs/pages/home-8/sec8-star.svg" alt="orisa" width={16} height={16} />
            ))}
        </>
    );
}
            ...
            <div className="container-fluid sec-8-home-8__container">
                <div className="sec-8-home-8__top d-flex align-items-end justify-content-between">
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="sec-8-home-8__kicker-icon" aria-hidden="true">
                            <Image src="/assets/imgs/pages/home-8/sec8-arrow.svg" alt="orisa" width={24} height={12} />
                        </span>
                    </div>
                ...
                <div className="sec-8-home-8__stage">
                    <div className="sec-8-home-8__center">
                        <Image className="sec-8-home-8__asterisk at-scroll-rotate" data-rotate-duration="12" data-rotate-sensitivity="0.18" data-rotate-boost="12" src="/assets/imgs/pages/home-8/sec8-asterisk.svg" alt="orisa" width={100} height={100} />
                                    ...
                                    <div className="sec-8-home-8__card">
                                        ...
                                        <div className="sec-8-home-8__body">
                                            <div className="sec-8-home-8__avatar">
                                                <Image src={t.avatar} alt="orisa" width={80} height={80} />
                                            </div>
