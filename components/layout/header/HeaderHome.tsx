...
export default function HeaderHome({ style }: HeaderHomeProps = {}) {
    const menuStyleClass = style ? ` ${style}` : "";
    return (
        <>
            <header>
                <div className="at-header-area at-header-spacing header-transparent header-home text-white">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-xl-2 col-6">
                                <div className="at-header-logo">
                                    <Link href="/home" className="d-inline-flex align-items-center gap-2 text-decoration-none">
                                        <Image
                                            width={49}
                                            height={54}
                            ...
                            <div className="col-xl-8 mx-auto d-none d-md-flex justify-content-center">
                                <div className={`at-main-menu menu-light${menuStyleClass} d-inline-flex justify-content-center`}>
                            ...
                            <div className="col-xl-2 col-6">
                                <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                                    <button className="at-menu-bar at-header-sidebar-btn text-white d-md-none" type="button" aria-label="Open menu">
            ...
            <style
                dangerouslySetInnerHTML={{
                    __html: `
                        .header-home .at-main-menu nav ul li a,
                        .header-home .at-main-menu nav ul li a:hover,
                        .header-home .at-main-menu nav ul li:hover.has-dropdown > a,
                        .header-home .at-main-menu nav ul li.has-dropdown > a {
                            color: #fff;
                        }
                        .header-home .at-main-menu nav ul li.has-dropdown > a::after {
                            filter: invert(1);
                        }
                        .header-home .at-header-logo a,
                        .header-home .at-header-logo h6 {
                            color: #fff;
                        }
                        .header-home .hamburger-sticky-menu {
                            color: #fff;
