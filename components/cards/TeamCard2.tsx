...
const DEFAULT_SOCIAL_LINKS: { key: keyof typeof SOCIAL_ICONS; label: string }[] = [
    ...
    return (
        <div className={[classList].filter(Boolean).join(" ")}>
            <div className="team-card-2">
                <div className="team-card-2__image">
                    <div className="anim-zoomin">
                        <Image src={img} alt={name} className="img-cover" width={450} height={550} />
                    </div>
                    <div className="team-card-2__social">
                        {links.map((item) => (
                            <a
                                key={item.key}
                                href={item.href}
                                className="team-card-2__social-link"
                ...
                <div className="team-card-2__content at_fade_anim" data-delay={delay}>
                    <Link href={link} className="team-card-2__name">
