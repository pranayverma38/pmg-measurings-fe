...
function Tile({ tile, filter }: { tile: Tile; filter: string }) {
    ...
    return (
        ...
        >
            <img className="sec-4-home-14__tile-img anim-zoomin" src={`/assets/imgs/pages/home-14/${tile.img}`} alt="Orisa" />
            ...
            <div className="sec-4-home-14__inner">
                ...
                <div className="sec-4-home-14__bottom">
                    ...
                    <div className="at-btn-group at_fade_anim" data-delay=".4" data-fade-from="bottom" data-ease="bounce">
                        ...
                        <Link className="at-btn z-index-1" href="/portfolio-1">Load 12 more</Link>
                        <Link className="at-btn-circle" href="/portfolio-1">{ARROW}</Link>
                    </div>
                </div>
            </div>
