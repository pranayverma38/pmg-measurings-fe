                    ...
                    <div className="col-lg-6 sec-1-home-7__right">
                        <div className="sec-1-home-7__content">
                            ...
                            <div className="sec-1-home-7__cta d-flex align-items-center flex-wrap gap-2 mb-60">
                                <Link href="/contact-1" className="sec-1-home-7__cta-btn at_fade_anim" data-start="100%" data-delay="0.3">
                                    <span>Start Your Journey</span>
                                </Link>
                                <Link href="/contact-1" className="sec-1-home-7__cta-arrow" aria-label="Start Your Journey">
                                    {CTA_ARROW_SVG}
                                </Link>
                            </div>
