                    ...
                    <div className="sec-1-home-12__hero-inner d-flex flex-column align-items-center text-center">
                        <div className="sec-1-home-12__pill at_fade_anim" data-fade-from="bottom" data-delay=".05">
                            <div className="sec-1-home-12__avatars" aria-hidden="true">
                                <img className="sec-1-home-12__avatar" src="/assets/imgs/pages/home-12/sec-1-avatar-1.webp" alt="Orisa" />
                                <img className="sec-1-home-12__avatar" src="/assets/imgs/pages/home-12/sec-1-avatar-2.webp" alt="Orisa" />
                                <img className="sec-1-home-12__avatar" src="/assets/imgs/pages/home-12/sec-1-avatar-3.webp" alt="Orisa" />
                                <img className="sec-1-home-12__avatar" src="/assets/imgs/pages/home-12/sec-1-avatar-4.webp" alt="Orisa" />
                            </div>
                        ...
                        <div className="sec-1-home-12__ctas at_fade_anim" data-fade-from="bottom" data-delay=".3">
                            <Link className="sec-1-home-12__btn-primary" href="/contact-1">
                            ...
                            <Link className="sec-1-home-12__btn-secondary" href="/pricing">
            ...
            <div className="sec-1-home-12__strip">
                <div ref={sliderRef} className="swiper sec-1-home-12-slider">
                    <div className="swiper-wrapper">
                        {slides.map((t, i) => (
                            <Link key={i} className={`swiper-slide sec-1-home-12__tile sec-1-home-12__tile--${t.mod}`} href="/portfolio-1" aria-label={`View portfolio item ${i + 1}`}>
                                <img className="sec-1-home-12__tile-img" src={`/assets/imgs/pages/home-12/${t.img}`} alt="Orisa" />
                            </Link>
                        ))}
                    </div>
                </div>
