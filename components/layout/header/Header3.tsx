    ...
    return (
        <>
            <header>
                <div className="at-header-area at-header-spacing header-transparent">
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-xl-7 me-auto d-none d-xl-block">
                ...
                <button id="header-sticky" type="button" className="hamburger-open-btn hamburger-sticky-menu" aria-label="Menu">
                    <span>MENU</span>
                    <span className="icon">
